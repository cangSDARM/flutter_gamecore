...
class Article extends StatelessWidget{
  Article({
    ...
    assert(avatarUrl==null || (avatarUrl!=null && usrName!=null)),  //avatar和usrName必须同时存在
    assert(theme==null || (theme!=null && info!=null && info.length==2)); //theme和info必须同时存在
  ...
  Row buildFooter(BuildContext context){
    return this.theme != null ? Row(
      children: [
        Text("${this.theme}    ", style: Theme.of(context).textTheme.headline),
